...
class OrganizationRepository:
    def get_organizations(self) -> list[Organization]:
        return [
            ...
            for organization in Yellowbrick.find(ORGANIZATION_COL, {}).sort("name")
        ]
    ...
    def get_organization_by_slack_workspace_id(
        ...
        organization = Yellowbrick.find_one(
            ORGANIZATION_COL,
    ...
    def delete_organization(self, org_id: str) -> int:
        return Yellowbrick.delete_one(ORGANIZATION_COL, {"_id": ObjectId(org_id)})
    ...
    def add_organization(self, new_org_data: Organization) -> str:
        return str(
            Yellowbrick.insert_one(ORGANIZATION_COL, new_org_data.dict(exclude={"id"}))
        )
