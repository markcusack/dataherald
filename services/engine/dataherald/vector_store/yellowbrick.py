...
class Yellowbrick(VectorStore):
    ...
    def __init__(self, system: System):
        ...
        if self.connection_string is None:
            raise ValueError("YELLOWBRICK_DB_CONNECTION_STRING environment variable not set")
        
        self.yellowbrick = {}
        self.embedding = {}

    def get_collection(self, collection: str, db_connection_id: str = None) -> YellowbrickDataherald:
        if collection in self.yellowbrick:
            ...
            _yellowbrick = YellowbrickDataherald(_embedding, self.connection_string, collection)
    ...
    def query(
        ...
        for query_text in query_texts:
            ...
            results.extend(self.convert_and_filter_results(query_results, db_connection_id))
    ...
    def add_record(
        ...
        self.get_collection(collection, db_connection_id).add_texts([documents], metadata)
